# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 10:15:36 2019
...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        # 网络参数 (Warning: if modifying something here, also make the change on save/loadParams() )
    ...
    def mainTrain(self, sess):
        ...
        # Not restoring from previous run
        if self.globStep == 0:
    ...
    def singlePredict(self, question, questionSeq=None):    
        """ 
        Args:   question (str): the raw input sentence
                questionSeq (List<int>): output argument. If given will contain the input batch sequence
        Return: list <int>: the word ids corresponding to the answer
        """
